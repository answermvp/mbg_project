...
class SigninIB_test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # 直客注册 MBG IB
        cls.page.get('https://trust.mbgmarkets.me/cn/register-ib.htm')
        # 时间戳，用于注册用户名拼接
    ...
    def test_2_signinIB_2(self, expect_username, expect_email, expect_phone, surName, lastName, nickName, papers_num, birthday, city, address, addressDate, addressEn, position, employerName, incomeComment):
        ...
        # self.signinIB_2(surName, lastName, nickName, str_papers_num, birthday, city, address, addressDate, addressEn, position, employerName, incomeComment)
        self.signinIB_2(surName, lastName, nickName, str_papers_num, birthday, city, address, addressDate, addressEn, position, employerName, incomeComment)
        # 断言自动载入的信息是否符合预期
