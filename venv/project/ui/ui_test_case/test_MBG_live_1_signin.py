...
class SigninUser_test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # MBG 
        cls.page.get('http://www.mbgmarkets.me/12082321-C00')
        # 时间戳，用于注册用户名拼接
    ...
    def signinuser_2(self, surName, lastName, nickName, papers_num, birthday, city, address, addressDate, addressEn, position, employerName, incomeComment):
        ...
        # <- 阅读条款
        # # 点击阅读
        # self.page.MBG_live_readed_button.click()
        # # 下拉滚动条到底部
        # # 切换到条款内容表单
    ...
    def signinuesr_3(self):
        ...
        # 直接写入文件的路径
        time.sleep(3)
        self.page.idcard_docFile_input.send_keys(file_path)
        # 选择文件
