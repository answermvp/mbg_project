...
class Check_Ib_Test(unittest.TestCase):
    ...
    def test1_signinIB_check(self):
        ...
        # 点击审核地址证明
        time.sleep(2)
        self.page.mbg_cleck_addre.click()
        # 点击复审通过按钮
        self.page.IB_review2suss_button.click()
        time.sleep(5)
        # 点击审核身份证明
        time.sleep(5)
        self.page.mbg_check_identity.click()
        # 点击复审通过按钮
        self.page.IB_review2suss_button.click()
        time.sleep(5)
        # 点击用户列表
        ...
        # time.sleep(2)
        # 点击 new_client 列的第一行
        self.page.new_client.click()
        # 点击资料
        self.page.info.click()
        time.sleep(5)
        # 点击 ready to activate 弹框的确定按钮
        self.page.ready_to_activate_alert.click()
        # 点击开启IB账号
        ...
        # # 输入入金金额
        # self.page.Ib_in_money.send_keys('10')
        # # 输入入金 comment
