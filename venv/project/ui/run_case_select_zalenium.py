...
def get_case_name(select_name):
    case_name =''
    # select_name = str(select_name)
    if select_name == '注册并激活ib':
        case_name = 'test_zalenium_MBG_ib_*.py'
    elif select_name == '注册并激活live':
        case_name = 'test_zalenium_MBG_live_*.py'
    elif select_name == '注册并激活demo':
        case_name = 'test_zalenium_MBG_demo*.py'
    elif select_name == '注册并激活直客':
        case_name = 'test_zalenium_MBG_zhike*.py'
    elif select_name == '以上全部执行':
        case_name = 'test_zalenium_MBG_*.py'
    else:
        pass
